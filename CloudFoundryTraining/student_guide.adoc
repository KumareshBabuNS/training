...
* Session 4 (link:labs/session_04/session_04.pdf[Slides])
** link:labs/session_04/lab_11/lab_11.html[Lab 11 - Build a Product Search/Details Service using PostgreSQL]
** link:labs/session_04/lab_12/lab_12.html[Lab 12 - Build a Product Review Service with MongoDB]
** link:labs/session_04/lab_13/lab_13.html[Lab 13 - Build a Product Recommendation Service with Neo4J]
